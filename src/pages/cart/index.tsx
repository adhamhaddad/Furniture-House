...
// ** Step Components
import StepCart from 'src/views/pages/checkout/StepCart'
import StepAddress from 'src/views/pages/checkout/StepAddress'
import StepPayment from 'src/views/pages/checkout/StepPayment'
import StepConfirmation from 'src/views/pages/checkout/StepConfirmation'
